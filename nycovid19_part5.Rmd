...
# Part 5: Map-Based Visualization

In the first parts of this tutorial series, we retrieved and examined data from local NYC sources and from the US Census. We combined the data into borough-level and zipcode-level statistics. 
